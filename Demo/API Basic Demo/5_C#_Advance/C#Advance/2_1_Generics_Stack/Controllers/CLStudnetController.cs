...
{
    public class CLStudnetController : ApiController
    {
        ...
        public CLStudnetController(IGenericService<Stu01> studentService)
        {
        ...
        public IHttpActionResult GetStudents()
        {
            ...
            Stack<Stu01> students = _genericStudentController.Get();
            return Ok(students);
        }
        /// <summary>
        ...
        public IHttpActionResult AddStudent([FromBody] Stu01 student)
        {
            ...
            Stack<Stu01> updatedStudents = _genericStudentController.Post(student);
        ...
        public IHttpActionResult DeleteStudent(int id)
        {
            ...
            Stack<Stu01> updatedStudents = _genericStudentController.Delete(id);
            return Ok(updatedStudents);
        }
    }
}
