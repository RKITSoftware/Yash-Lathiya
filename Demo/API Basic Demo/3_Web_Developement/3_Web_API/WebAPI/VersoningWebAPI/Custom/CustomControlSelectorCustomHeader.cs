...
namespace VersoningWebAPI.Custom
{
    ...
    /// </summary>
    public class CustomControlSelectorCustomHeader : DefaultHttpControllerSelector
    {
        ...
        public CustomControlSelectorCustomHeader(HttpConfiguration config) : base(config)
        {
            config = _config;
        }
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            string customHeaderVersion = "Student-API-Version";
