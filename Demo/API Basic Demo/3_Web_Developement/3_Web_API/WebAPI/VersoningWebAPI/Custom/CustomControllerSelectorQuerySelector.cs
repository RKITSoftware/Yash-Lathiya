...
{
    /// <summary>
    /// Manages Versioning by applying method of Query Selector Method
    /// </summary>
    public class CustomControllerSelectorQuerySelector : DefaultHttpControllerSelector
    {
        ...
        public CustomControllerSelectorQuerySelector(HttpConfiguration config) : base(config) 
        {
            config = _config;
        }

        /// <summary>
        /// Logic of web api to select which controller on basis of QuerySelector
        /// </summary>
