...
export default function popupTemplateForWithFramework(container) {
    $(container).append(`
    ...
    $.get("../assets/data/projectConfigurations/withFramework.json", configurations => {
